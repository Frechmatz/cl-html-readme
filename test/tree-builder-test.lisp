...
(define-test test-tree-builder-1 ()
	     (let ((builder (make-instance 'cl-readme-dsl:tree-builder)))
	       (cl-readme-dsl:add-text builder "1")
	       (cl-readme-dsl:add-text builder "2")
	       (let ((tree (cl-readme-dsl:get-tree builder)))
...
(define-test test-tree-builder-2 ()
	     (let ((builder (make-instance 'cl-readme-dsl:tree-builder)))
	       (cl-readme-dsl:open-element builder 'heading (list :name "heading-name"))
	       (cl-readme-dsl:close-element builder)
	       (let ((tree (cl-readme-dsl:get-tree builder)))
...
(define-test test-tree-builder-4 ()
	     (let ((builder (make-instance 'cl-readme-dsl:tree-builder)))
	       (cl-readme-dsl:add-text builder "1")
	       (cl-readme-dsl:open-element builder 'heading (list :name "heading-name"))
	       (cl-readme-dsl:add-text builder "1.1")
	       (cl-readme-dsl:close-element builder)
	       (cl-readme-dsl:add-text builder "2")
	       (let ((tree (cl-readme-dsl:get-tree builder)))
		 (assert-equal 3 (length tree))
...
(define-test test-tree-builder-invalid-text-1 ()
	     (let ((builder (make-instance 'cl-readme-dsl:tree-builder)))
	       (let ((catched-error nil))
		 (handler-case
		     (cl-readme-dsl:add-text builder :text-1)
		   (error (err)
		     (setf catched-error err)))
		 (assert-true catched-error))))
...
(define-test test-tree-builder-invalid-text-2 ()
	     (let ((builder (make-instance 'cl-readme-dsl:tree-builder)))
	       (let ((catched-error nil))
		 (handler-case
		     (cl-readme-dsl:add-text builder nil)
		   (error (err)
		     (setf catched-error err)))
		 (assert-true catched-error))))
...
(define-test test-tree-builder-invalid-element ()
	     (let ((builder (make-instance 'cl-readme-dsl:tree-builder)))
	       (let ((catched-error nil))
		 (handler-case
		     (cl-readme-dsl:open-element builder 'xxxx ())
		   (error (err)
		     (setf catched-error err)))
		 (assert-true catched-error))))
